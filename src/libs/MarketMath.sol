...
library MarketMath {
     ...
     */
    function collateralToShares(uint256 collateralAmount, uint256 price) internal pure returns (uint256) {
        if (price == 0) return 0;
     ...
     */
    function sharesToCollateral(uint256 shareAmount, uint256 price) internal pure returns (uint256) {
